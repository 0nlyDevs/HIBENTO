...
export const faqItems: FAQItem[] = [
  { q: "Do attendees need an account?", a: "Nope. Schedule, live sessions, Q&A, favourites — all public, no sign-up. Just a link." },
  ...
  { q: "Can I theme it for my event?", a: "Yes — HiBento uses a beautiful Obsidian + Gold + Teal theme that adapts to your event style automatically." },
];
