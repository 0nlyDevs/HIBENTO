...
export function TypingAnimation({
  ...
  const previousAnimationSourceKey = useRef(animationSourceKey);

  useEffect(() => {
    if (previousAnimationSourceKey.current !== animationSourceKey) {
      previousAnimationSourceKey.current = animationSourceKey;
      setDisplayedText("");
