...
export function EventDetailSkeleton() {
  return (
    <div className="pt-16 pb-24" aria-label="Loading event details">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative overflow-hidden squircle-lg min-h-65 flex flex-col justify-end mb-4 motion-safe:animate-pulse" aria-hidden="true">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4" aria-hidden="true">
          {[
        ...
        <div id="event-schedule" className="mb-10 scroll-mt-28" aria-hidden="true">
