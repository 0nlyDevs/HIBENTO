...
export const Nav = ({ links, ctaHref = "#product", ctaLabel = "Program" }: { links?: NavLink[]; ctaHref?: string; ctaLabel?: string }) => {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 flex items-center justify-start gap-1 px-10 py-8 pointer-events-none">
      ...
      <div
        ...
        style={glassStyle}
      >
        <Link href={logoHref} className="flex items-center pl-1 pr-5 border-r border-dashed border-white/15 shrink-0">
          <Image
